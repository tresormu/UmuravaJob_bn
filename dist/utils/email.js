...
export const sendApplicationReceivedEmail = async (to, jobTitle, candidateName) => {
...
export const sendApplicationStatusEmail = async (to, jobTitle, status, candidateName) => {
...
export const sendJobPostedEmail = async (to, jobTitle) => {
...
export const sendShortlistedEmail = async (to, jobTitle, candidateName) => {
...
export const sendRecruiterDeletionEmail = async (to, firstName) => {
